...
#elif (HSE_S32K3X1 == HSE_PLATFORM)
#define MU_INSTANCE0 ((uint32_t)0x4038C000UL) /**< @brief MU0 base address */
#define MU_INSTANCE1 ((uint32_t)0x40439000UL) /**< @brief MU1 base address */
...
#define MU_INSTANCE0 ((uint32_t)0x4038C000UL) /**< @brief MU0 base address */
#define MU_INSTANCE1 ((uint32_t)0x404EC000UL) /**< @brief MU1 base address */
#elif (HSE_S32K3X6 == HSE_PLATFORM)
#define MU_INSTANCE0 ((uint32_t)0x4038C000UL) /**< @brief MU0 base address */
#define MU_INSTANCE1 ((uint32_t)0x404EC000UL) /**< @brief MU1 base address */
#elif (HSE_S32K358 == HSE_PLATFORM)
#define MU_INSTANCE0 ((uint32_t)0x4038C000UL) /**< @brief MU0 base address */
#define MU_INSTANCE1 ((uint32_t)0x404EC000UL) /**< @brief MU1 base address */
#elif (HSE_S32K388 == HSE_PLATFORM)
#define MU_INSTANCE0 ((uint32_t)0x4038C000UL) /**< @brief MU0 base address */
#define MU_INSTANCE1 ((uint32_t)0x404EC000UL) /**< @brief MU1 base address */
#else
