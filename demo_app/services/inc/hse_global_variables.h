...
=============================================================================*/
    ...
    *                                             ENUMS
    ...
    typedef enum
    {
        ...
        SBAF_UPDATE_SUCCESS = 0x00400000,
        SHE_SERVICE_DISABLED = 0x00800000,
        ACE_SERVICE_SUCCESS = 0x01000000,
    } testStatus_t;
...
typedef enum
{
    ...
    GET_KEY_INFO_STARTED = 1024,
    RSA_EXAMPLE_STARTED = 2048,
    AEAD_EXAMPLE_STARTED = 4096,
    PUBLISH_KEYSTORE_RAMTOFLASH_EXAMPLE_STARTED = 16384
...
typedef enum
{
    ...
    GET_KEY_INFO_SUCCESS = 1024,
    RSA_EXAMPLE_SUCCESS = 2048,
    AEAD_EXAMPLE_SUCCESS = 4096,
    PUBLISH_KEYSTORE_RAMTOFLASH_EXAMPLE_SUCCESS = 16384
